...
//Try looping through the string, keeping a count of how many open parentheses 
//we have.

//Solution
//We simply walk through the string, starting at our input opening parenthesis 
//position. As we iterate, we keep a count of how many additional "(" we find 
//as openNestedParens. When we find a ")" we decrement openNestedParens. 
//If we find a ")" and openNestedParens is 0, we know that ")" closes our initial 
...
// What We Learned
// The trick to many "parsing" questions like this is using a stack to track 
//which brackets/phrases/etc are "open" as you go.

// So next time you get a parsing question, one of your first thoughts should be 
//"use a stack!"

// In this problem, we can realize our stack would only hold '(' characters. 
//So instead of storing each of those characters in a stack, we can store the 
//number of items our stack would be holding.
